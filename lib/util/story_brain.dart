import 'package:super_app/models/story.dart';
...
class StoryBrain {
  ...
  void nextStoy(int choiceNumber) => _storyNumber = choiceNumber == 1
      ? _storyData[_storyNumber].choice1Story
      : _storyData[_storyNumber].choice2Story;
}
